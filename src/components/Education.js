...
export default function Education() {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center font-robotoSlab" style={{ background: '#edf2fb' }} id="studies">
            <h1 className="text-3xl md:text-5xl font-bold pt-5 md:pb-11 text-center">My Educations</h1>
            <div className="w-11/12 md:max-w-3xl text-xl text-center">
                <div className="relative flex flex-col min-w-0 break-words w-full mb-6 rounded">
                    <div className="px-4 py-5 flex-auto">
                        <div className="bg-gray-50 shadow overflow-hidden sm:rounded-t-lg">
                        ...
                        <div className="bg-gray-50 shadow overflow-hidden sm:rounded-b-lg">
                            <div className="px-4 py-5 sm:px-6">
