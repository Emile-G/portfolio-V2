...
export default function Stack() {
    return (
        <div className="min-h-screen flex flex-col items-center justify-center font-robotoSlab" id="stack">
            <h1 className="text-4xl md:text-5xl font-bold">The Techs I use</h1>
