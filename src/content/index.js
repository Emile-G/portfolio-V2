export default {
    ...
    header: {
        img:
            'https://i.ibb.co/Srj040h/Emile-Gv2.png',
        imgPlaceholder:
        ...
        text: ['Hi!', "I'm Emile Gardent.", 'I\'m a '],
        typical: [
            'PHP Developer.💻',
            2000,
            'Symfony Developer.🖥️',
    ...
    tech1: {
        ...
        tech: [
            {
                img: process.env.PUBLIC_URL + '/assets/mysql_PNG19.png',
                alt: 'MySQL',
            },
            {
                img: process.env.PUBLIC_URL + '/assets/php512.png',
                alt: 'PHP 7.3',
            },
            {
                img: process.env.PUBLIC_URL + '/assets/symfony_laravel.png',
                alt: 'Symfony && Laravel',
            },
            {
                img: process.env.PUBLIC_URL + '/assets/vector-javascript-1.png',
                alt: 'Javascript',
            },
        ],
        ...
        study: [
            {
                ...
                webisteData: 'https://www.epsi.fr/',
                fullDiplomaName: 'in application conception and application programing.',
            },
            {
                ...
                website: 'https://www.estran-brest.fr/',
                webisteData: 'https://www.estran-brest.fr/charles-de-foucauld/lenseignement-superieur/bts-sio/',
                fullDiplomaName: 'in web and web application developing.',
            },
            {
                ...
                webisteData: 'http://lycee-chaptal-saintbrieuc.fr/',
                fullDiplomaName: 'in science and technology in sustainable development with a major in computer science.',
            },
        ]
    },
    professionalExp: {
        ...
        experiences: [
            {
                ...
                image: 'https://i.ibb.co/0QfzTTZ/site-gie.png',
                imgPlaceholder:
                    'data:image/jpeg;base64,',
